...
$db = new DataSource();?>
  <?php if(isset($_POST['CANCEL'])){unset($_POST['CANCEL']);};?>
   <div class="tab-wrap">
     ...
     <input id="TAB-23" type="radio" name="TAB" class="tab-switch"  /><label class="tab-label" for="TAB-23">社内在庫移動</label>
...
<input type="submit" value="テストデータ(inputtestdata.xlsx)"/>
    ...
    <input id="TAB-24" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-24">在庫検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-25" type="radio" name="TAB" class="tab-switch" checked /><label class="tab-label" for="TAB-25">オーダー検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-26" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-26">入力検索</label>
    <div class="tab-content">
