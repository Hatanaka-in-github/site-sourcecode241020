...
$db = new DataSource();?>
  <?php if(isset($_POST['CANCEL'])){unset($_POST['CANCEL']);};?>
   <div class="tab-wrap">
     ...
     <input id="TAB-19" type="radio" name="TAB" class="tab-switch"  /><label class="tab-label" for="TAB-19">社内在庫移動</label>
...
<input type="submit" value="テストデータ(inputtestdata.xlsx)"/>
    ...
    <input id="TAB-20" type="radio" name="TAB" class="tab-switch" checked /><label class="tab-label" for="TAB-20">在庫検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-21" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-21">オーダー検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-22" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-22">入力検索</label>
    <div class="tab-content">
