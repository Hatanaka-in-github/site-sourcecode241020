...
$db = new DataSource();?>
  <?php if(isset($_POST['CANCEL'])){unset($_POST['CANCEL']);};?>
   <div class="tab-wrap">
     ...
     <input id="TAB-27" type="radio" name="TAB" class="tab-switch"  /><label class="tab-label" for="TAB-27">社内在庫移動</label>
...
<input type="submit" value="テストデータ(inputtestdata.xlsx)"/>
    ...
    <input id="TAB-28" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-28">在庫検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-29" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-29">オーダー検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-30" type="radio" name="TAB" class="tab-switch" checked /><label class="tab-label" for="TAB-30">入力検索</label>
    <div class="tab-content">
