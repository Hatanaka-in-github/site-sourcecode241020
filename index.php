...
<div class="card text-center">
      ...
      <div class="card-body">
        ...
        <a href="./admin" class="btn btn-primary">1.工程設計</a>
      </div>
    </div>
...
$db = new DataSource();?>
  <?php if(isset($_POST['CANCEL'])){unset($_POST['CANCEL']);};?>
   <div class="tab-wrap">
     ...
     <input id="TAB-15" type="radio" name="TAB" class="tab-switch" checked /><label class="tab-label" for="TAB-15">社内在庫移動</label>
...
<form method="POST" action="download_sample.php">
<input type="hidden" name="file" value="./format/manual.xlsx" />
<input type="submit" value="操作方法(manual.xlsx)"/>
</form>
<form method="POST" action="download_sample.php">
<input type="hidden" name="file" value="./testdata/inputtestdata.xlsx" />
<input type="submit" value="テストデータ(inputtestdata.xlsx)"/>
</form>
     </div>



    <input id="TAB-16" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-16">在庫検索</label>
    <div class="tab-content">

      <h2 class="bg-primary">全在庫検索</h2>
      <form action="index2.php" method="POST" class="form-group">
    ...
    <input id="TAB-17" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-17">オーダー検索</label>
    <div class="tab-content">
    ...
    <input id="TAB-18" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-18">入力検索</label>
    <div class="tab-content">
